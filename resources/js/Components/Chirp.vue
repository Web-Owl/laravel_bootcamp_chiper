...
import IconLike from '@/Utils/IconLike.vue'
...
<template>
    <div class="p-6 flex space-x-2">
        ...
        <div class="flex-1">
            ...
            <p v-else class="my-4 text-lg text-gray-900">{{ chirp.message }}</p>
            <Link preserve-scroll
                          method="POST"
                          as="button"
                          :href="`/chirps/${chirp.id}/like`">
              <IconLike class="w-4 h-4" :name="chirp.liked ? 'heart' : 'heart-outline'"></IconLike>
            </Link>
        </div>
    </div>
</template>